...
public class TbWarnModel implements Serializable {
    ...
    public BigInteger getFwarntime() {
        return fwarntime;
    }

    public void setFwarntime(BigInteger fwarntime) {
