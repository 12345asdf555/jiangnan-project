...
public class TbAlarmModel implements Serializable {
    ...
    public BigInteger getFalarmtime() {
        return falarmtime;
    }

    public void setFalarmtime(BigInteger falarmtime) {
